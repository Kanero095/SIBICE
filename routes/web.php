...
Route::get('/home',[
    DefaultController::class, 'dashboard'])->name('dashboard');
Route::get('/visi-misi',[
    DefaultController::class, 'visi_misi'])->name('visi-misi');
Route::get('/galery',[
    DefaultController::class, 'galery'])->name('galery');
Route::get('/activities',[
    DefaultController::class, 'activities'])->name('activities');
Route::get('/tenants',[
    DefaultController::class, 'tenants'])->name('tenants');
Route::get('/tenants/view/{slug}', [
    DefaultController::class,'show_tenant'])->name('show-tenant');

Route::get('/auth/redirect', [
    GoogleController::class, 'redirect'])->name('redirect');
Route::get('/auth/google/callback', [
    GoogleController::class, 'callback'])->name('callback');
